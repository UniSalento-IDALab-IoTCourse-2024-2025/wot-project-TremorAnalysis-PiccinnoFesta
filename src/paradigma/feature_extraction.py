...
def compute_mfccs(
    ...
    print("power_filtered.shape:", power_filtered.shape)
    print("power_filtered.dtype:", power_filtered.dtype)
    print("DEBUG power_filtered:", power_filtered)
    print("Type:", type(power_filtered))
    # Convert power to logarithmic scale
    power_filtered = np.array(power_filtered.tolist(), dtype=np.float64)  # forza conversione vera
